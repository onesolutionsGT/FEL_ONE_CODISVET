...
/****** Object:  StoredProcedure [dbo].[FELONE_ECOFACTURAS_FCAM]    Script Date: 8/4/2022 5:00:29 PM ******/
SET ANSI_NULLS ON
GO
...
CREATE PROCEDURE [dbo].[FELONE_ECOFACTURAS_FCAM] (@DOCENTRY INT,@DECIMAL INT)
AS
...
SELECT DISTINCT			
			...
			@Tipo = 'FCAM',
			@DocNum = t0.DocNum,
			@FechaHoraEmision = convert(varchar, T0.DocDate, 23),
	...
	group by a."ItemCode",a."LineTotal",a."VatSum",a."Currency",a."TotalFrgn",a."VatSumFrgn",a."Quantity",a."Dscription",a."TaxCode",a."PriceBefDi","INMPrice", a.U_Tipo;
		...
		ELSE		
			BEGIN
				...
				SET @DTEDETAAUX=@DTEDETAAUX+ '<Columna1>'+@Descripcion+'</Columna1>'
