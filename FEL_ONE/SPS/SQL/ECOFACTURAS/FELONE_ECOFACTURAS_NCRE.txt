...
/****** Object:  StoredProcedure [dbo].[FELONE_ECOFACTURAS_NCRE]    Script Date: 8/4/2022 5:01:16 PM ******/
SET ANSI_NULLS ON
GO
...
CREATE PROCEDURE [dbo].[FELONE_ECOFACTURAS_NCRE] (@DOCENTRY INT,@DECIMAL INT)
AS
