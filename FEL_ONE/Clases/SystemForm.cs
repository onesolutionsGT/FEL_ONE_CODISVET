                        ...
                        try
                        {
                            ...
                            if (oFormLink.Mode == SAPbouiCOM.BoFormMode.fm_OK_MODE)
                            {
                                ...
                                if (!string.IsNullOrEmpty(url))
                                {
                                    ...
                                    if (string.IsNullOrEmpty(firmax))
                                    {
                                        SBO_Application.MessageBox("Este documento no tiene informacion de Firma");
                                    }
                                    else
                                    {
                                        if (Utils.FEL == Utils.TipoFEL.INFILE)
                                        ...
                                        {
                                            SBO_Application.MessageBox("Para esta operacion debe tener activo el certificador INFILE.");
                                        }
                                    }
                                }
                                else
